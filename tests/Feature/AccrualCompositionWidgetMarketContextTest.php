...
class AccrualCompositionWidgetMarketContextTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $method = new ReflectionMethod(AccrualCompositionWidget::class, 'resolveMarketIdForWidget');
        $method->setAccessible(true);

        return $method->invoke(new AccrualCompositionWidget, $user);
    }
