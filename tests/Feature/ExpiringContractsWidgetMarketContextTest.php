...
class ExpiringContractsWidgetMarketContextTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $method = new ReflectionMethod(ExpiringContractsWidget::class, 'resolveMarketIdForWidget');
        $method->setAccessible(true);

        return $method->invoke(new ExpiringContractsWidget, $user);
    }
