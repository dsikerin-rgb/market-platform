...
class TenantActivityStatsWidgetMarketContextTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $method = new ReflectionMethod(TenantActivityStatsWidget::class, 'resolveMarketIdForWidget');
        $method->setAccessible(true);

        return $method->invoke(new TenantActivityStatsWidget, $user);
    }
