...
class RecentTenantRequestsWidgetMarketContextTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $method = new ReflectionMethod(RecentTenantRequestsWidget::class, 'resolveMarketIdForWidget');
        $method->setAccessible(true);

        return $method->invoke(new RecentTenantRequestsWidget, $user);
    }
