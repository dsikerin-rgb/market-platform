...
class MarketAttentionWidgetMarketContextTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $method = new ReflectionMethod(MarketAttentionWidget::class, 'resolveMarketId');
        $method->setAccessible(true);

        return $method->invoke(new MarketAttentionWidget);
    }
