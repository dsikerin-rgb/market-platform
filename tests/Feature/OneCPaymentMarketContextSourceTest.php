...
class OneCPaymentMarketContextSourceTest extends TestCase
{
    public function test_payment_import_wraps_processing_in_market_context(): void
    {
        $source = file_get_contents(app_path('Http/Controllers/Api/OneC/PaymentController.php'));
