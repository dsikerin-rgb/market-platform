...
class OneCDebtSnapshotsHistoryWidgetTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $method = new ReflectionMethod(OneCDebtSnapshotsHistoryWidget::class, 'resolveMarketIdForWidget');
        $method->setAccessible(true);

        return $method->invoke(new OneCDebtSnapshotsHistoryWidget, $user);
    }
