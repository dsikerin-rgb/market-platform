...
class SpaceReviewFlowTest extends TestCase
{
    ...
    public function test_review_results_page_renders_quick_observed_actions(): void
    {
        ...
        $this->get(MapReviewResults::getUrl(['tab' => 'review']))
            ...
            ->assertSee('Выберите ручное решение для истории ревизии. Некоторые варианты только фиксируют наблюдение, а варианты подтверждения применяют безопасное изменение к месту.', false)
