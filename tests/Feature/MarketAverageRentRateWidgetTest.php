...
class MarketAverageRentRateWidgetTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $method = new ReflectionMethod(MarketAverageRentRateWidget::class, 'resolveMarketIdForWidget');
        $method->setAccessible(true);

        return $method->invoke(new MarketAverageRentRateWidget, $user);
    }
