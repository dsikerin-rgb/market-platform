...
class OneCAccrualPaymentReconciliationDetailWidgetTest extends TestCase
{
    ...
    {
        $method = new ReflectionMethod(OneCAccrualPaymentReconciliationDetailWidget::class, 'resolveMarketIdForWidget');
        $method->setAccessible(true);

        return $method->invoke(new OneCAccrualPaymentReconciliationDetailWidget, $user);
    }
