...
class MarketOverviewStatsWidgetMarketContextTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_super_admin_widget_has_no_default_market_without_context(): void
    {
        ...
        self::assertSame(0, $this->resolvedMarketId($superAdmin));
    }
    ...
    {
        $method = new ReflectionMethod(MarketOverviewStatsWidget::class, 'resolveMarketIdForWidget');
        $method->setAccessible(true);

        return $method->invoke(new MarketOverviewStatsWidget, $user);
    }
