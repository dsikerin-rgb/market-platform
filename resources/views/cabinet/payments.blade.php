<x-cabinet-layout :tenant="auth()->user()->tenant" title="Оплата">
    <section class="rounded-3xl bg-white border border-slate-200 p-5 shadow-sm space-y-4">
        <div class="h-12 w-12 rounded-2xl bg-sky-600 text-white flex items-center justify-center">
        ...
        <div class="grid grid-cols-2 gap-2">
            <a class="rounded-2xl bg-sky-600 text-white text-center px-4 py-3 text-sm font-semibold" href="{{ route('cabinet.accruals') }}">К начислениям</a>
