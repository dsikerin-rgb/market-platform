...
<head>
    ...
    <title>Приглашение в команду рынка «{{ $marketName }}»</title>
</head>
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="width:100%;max-width:640px;border-collapse:separate;border-spacing:0;">
                    <tr>
                        <td align="center" style="padding:0 0 18px;">
                            @if($logoUrl)
                                <img src="{{ $logoUrl }}" alt="{{ $brandName }}" width="180" style="display:block;max-width:180px;height:auto;border:0;outline:none;text-decoration:none;">
                            @else
                    ...
                    <tr>
                        <td style="background:#ffffff;border:1px solid #d8e4f2;border-radius:18px;padding:34px 40px;box-shadow:0 10px 28px rgba(16,42,79,.08);">
                            <h1 style="margin:0 0 18px;font-size:26px;line-height:1.25;color:#132238;font-weight:800;">Приглашение в команду рынка</h1>
                            <p style="margin:0 0 14px;font-size:17px;line-height:1.55;color:#51627a;">
