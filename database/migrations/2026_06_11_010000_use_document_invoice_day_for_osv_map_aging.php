    ...
    public function up(): void
    {
        Market::query()
            ...
            ->each(function (Market $market): void {
                ...
                if (($debtMonitoring['settlement_map_aging_policy'] ?? null) !== DebtDecisionPolicy::AGING_INVOICE_DAY) {
                    return;
                }
    ...
    public function down(): void
    {
        Market::query()
            ...
            ->each(function (Market $market): void {
                ...
                $debtMonitoring['settlement_map_aging_policy'] = DebtDecisionPolicy::AGING_INVOICE_DAY;
                $settings['debt_monitoring'] = $debtMonitoring;
