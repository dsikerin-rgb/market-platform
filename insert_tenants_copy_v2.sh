...
echo "First 5: $(head -5 /tmp/staging_tenants.txt | tr '\n' ',')"
echo "Last 5: $(tail -5 /tmp/staging_tenants.txt | tr '\n' ',')"
...
echo "First 5: $(head -5 /tmp/prod_needed_tenants.txt | tr '\n' ',')"
echo "Last 5: $(tail -5 /tmp/prod_needed_tenants.txt | tr '\n' ',')"

# Find missing IDs using grep
