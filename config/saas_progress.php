...
return [
    ...
    'current_focus' => 'Перевести marketplace:images:localize на безопасный dry-run по умолчанию, --execute только с явным --market и MarketContext.',
