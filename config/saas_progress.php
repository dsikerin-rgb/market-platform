...
return [
    ...
    'current_focus' => 'Перевести marketplace:warm-demo-assets на безопасный dry-run по умолчанию и восстановить контракт demo image banks без реальных загрузок без --execute.',
    'next_step' => 'Дальше разбирать оставшиеся write-capable команды отдельными пакетами: repair, backfill, cleanup, seed, marketplace и AI сценарии.',
