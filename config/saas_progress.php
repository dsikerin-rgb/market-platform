...
return [
    ...
    'current_focus' => 'Public demo открыт на prod через lead-gated entry: контакт сохраняется перед входом, общий пароль не публикуется, существующая admin-сессия не подменяется demo-пользователем.',
    'next_step' => 'Обработать первые входящие заявки: проверить источник, связаться с лидом, отметить статус, квалифицировать для показа или пилота и не смешивать тестовые заявки с реальными.',
    ...
    'stages' => [
        ...
        [
            ...
            'items' => [
                ...
                ['title' => 'Public demo entry подготовлен и задеплоен: /demo открывает synthetic demo-директора после короткой формы контакта, без публикации общего пароля', 'status' => 'done'],
        ...
        [
            ...
            'weight' => 8,
            'status' => 'done',
            'summary' => 'Сайт-визитка, заявка на демо, пилот, таблица лидов, презентационный сценарий и коммерческое предложение.',
            'items' => [
                ['title' => 'Landing page', 'status' => 'done'],
                ['title' => 'Форма заявки', 'status' => 'done'],
                ['title' => 'Сохранение и уведомления по заявкам', 'status' => 'done'],
                ['title' => 'Простой вход в demo с landing без общего пароля через feature flag', 'status' => 'done'],
                ['title' => 'Презентация и КП: сценарий показа, состав пилота, ограничения бесплатной версии и следующий шаг для клиента', 'status' => 'done'],
                ['title' => 'Таблица первых лидов', 'status' => 'done'],
                ['title' => 'Регламент обработки первых лидов: SLA, квалификационные вопросы, шаблон ответа и public demo flag checklist', 'status' => 'done'],
                ['title' => 'Быстрые статусы заявок: Связались, Квалифицирована, Не подходит с автоматической отметкой времени обработки', 'status' => 'done'],
            ],
        ],
        [
            'key' => 'rollout',
            ...
            'weight' => 10,
            'status' => 'done',
            'summary' => 'Контролируемый выпуск: staging, smoke, prod и последующая проверка публичного demo выполнены.',
            'items' => [
                ...
                ['title' => 'Prod public demo flag включён отдельным решением после staging/prod smoke', 'status' => 'done'],
                ['title' => 'Public demo readiness checklist добавлен для staging/prod перед включением /demo', 'status' => 'done'],
                ['title' => 'Public demo smoke checklist расширен проверками staff rail и выхода из кабинета арендатора после найденных regressions', 'status' => 'done'],
