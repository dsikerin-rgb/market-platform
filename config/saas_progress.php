...
return [
    ...
    'current_focus' => 'Demo-карта на staging сбалансирована после ручной отрисовки: 228/228 фигур привязаны, крупные острова O2/O5/O6/O7 разделены на 2-4 групповых места с разными арендаторами, лучшие торговые зоны арендуемые, служебная площадь больше не доминирует, ставки подняты примерно на 30% с сохранением зональной дифференциации. Prod-данные demo-рынка не создавались.',
    'next_step' => 'Проверить demo-карту визуально в роли директора на staging, затем отдельным безопасным пакетом решить схему demo-контура на prod: отдельный demo-рынок, доступы, ограничения и сценарий показа без влияния на реальный рынок.',
