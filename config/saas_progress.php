...
return [
    ...
    'current_focus' => 'Перевести marketplace:announcements:dedupe на безопасный dry-run по умолчанию, --execute только с явным --market и MarketContext.',
