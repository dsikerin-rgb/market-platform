...
return [
    ...
    'current_focus' => 'Перевести operations:rebuild-space-snapshots на безопасный dry-run по умолчанию, сохранив штатное расписание через явный --execute --all-markets.',
