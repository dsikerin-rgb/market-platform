...
return [
    ...
    'current_focus' => 'Demo-карта на staging сбалансирована после ручной отрисовки: 228/228 фигур привязаны, острова O1-O9 оформлены как групповые места, лучшие торговые зоны переведены в арендуемые, служебная площадь больше не доминирует. Prod-данные demo-рынка не создавались.',
    'next_step' => 'Проверить demo-карту визуально в роли директора на staging, затем отдельным безопасным пакетом решить схему demo-контура на prod: отдельный demo-рынок, доступы и ограничения без влияния на реальный рынок.',
    ...
    'stages' => [
        ...
        [
            ...
            'items' => [
                ...
                ['title' => 'Demo-карта на staging сбалансирована: 228/228 фигур привязаны, острова O1-O9 оформлены как групповые места, 130 дочерних мест, 9 родительских групп, лучшие торговые зоны арендуемые, 0 фигур без привязки', 'status' => 'done'],
