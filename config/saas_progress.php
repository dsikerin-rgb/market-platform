...
return [
    ...
    'current_focus' => 'Demo-карта на staging наполнена после ручной отрисовки: 221/221 фигур привязаны, острова O1-O9 оформлены как групповые места, баланс занято/свободно/служебно проверен. Prod-данные demo-рынка не создавались.',
    ...
    'stages' => [
        ...
        [
            ...
            'items' => [
                ...
                ['title' => 'Demo-карта на staging наполнена: 221/221 фигур привязаны, острова O1-O9 оформлены как групповые места, 130 дочерних мест, 9 родительских групп, 0 фигур без привязки', 'status' => 'done'],
