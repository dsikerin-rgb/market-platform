    ...
    'stages' => [
        ...
        [
            ...
            'items' => [
                ...
                ['title' => 'Filament resources/pages используют единый context: ReportResource + ReportRunResource + MarketLocationTypeResource + MarketSpaceTypeResource + TaskCommentResource + TaskWatcherResource + MarketHolidayResource + MarketplaceSlideResource + StaffResource + StaffForm + IntegrationExchangeResource + TenantResource + MarketSettings + MarketplaceSettings + MapReviewResults + OpsDiagnostics + OperationResource + StaffInvitationResource + StaffInvitationForm + MarketLocationResource + MarketSpaceGroupEpisodeResource + CreateMarketLocation + EditMarketLocation + EditMarketSpace + MarketSpaceResource + CreateMarketSpace + TenantContractResource + ListTenantContracts + TenantAccrualResource + TenantAccrualsTable + ListTenantAccruals + 1C reconciliation report переведены', 'status' => 'in_progress'],
                ['title' => 'Dashboard/widgets/Livewire используют единый context: 17 widget + Dashboard page + MarketSwitcherWidget sync + StaffLiveFeed + OnlineStaffRail + QuickChatDrawer переведены', 'status' => 'in_progress'],
