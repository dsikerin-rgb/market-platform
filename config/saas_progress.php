...
return [
    ...
    'current_focus' => 'Перевести notifications:limit-market-admins-to-messages на безопасный dry-run по умолчанию, --execute только с явным --market и MarketContext.',
