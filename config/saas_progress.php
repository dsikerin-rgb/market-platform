...
return [
    ...
    'stages' => [
        ...
        [
            ...
            'items' => [
                ['title' => 'BelongsToMarket trait', 'status' => 'pending'],
                ['title' => 'MarketScope', 'status' => 'pending'],
                ['title' => 'Режим disabled/shadow при flags off', 'status' => 'pending'],
                ['title' => 'Тесты scope enabled/disabled', 'status' => 'pending'],
                ['title' => 'Явный bypass для системных сценариев', 'status' => 'pending'],
            ],
        ],
        [
