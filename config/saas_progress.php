...
return [
    ...
    'current_focus' => 'Перевести tenants:reset-debt-status на явный MarketContext для --market режима и сделать dry-run режимом по умолчанию.',
