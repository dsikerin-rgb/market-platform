...
return [
    ...
    'current_focus' => 'Перевести space-review:reconcile на явный MarketContext для --market режима без изменения all-market read-only диагностики.',
    ...
    'stages' => [
        ...
        [
            ...
            'items' => [
                ...
                ['title' => 'Jobs/commands получают market_id явно: 1C finance commands, scheduled calendar/snapshot commands, read-only audit/report commands, preview/apply contract maintenance commands, notification health-check, occupancy reconcile, maintenance reconcile и space-review reconcile подготовлены', 'status' => 'in_progress'],
                ['title' => 'Smoke matrix для UI/API/jobs: regression guards для API, 1C commands, scheduled commands, audit commands, preview/apply commands, notification health command, occupancy reconcile command, maintenance reconcile command, space-review reconcile command и 1C reconcile cutover diagnostics добавлены', 'status' => 'in_progress'],
            ],
        ],
        [
            'key' => 'write_guards',
