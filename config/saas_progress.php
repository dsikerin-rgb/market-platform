...
return [
    ...
    'current_focus' => 'Public demo entry задеплоен, а входящие demo/pilot-заявки из landing выводятся во внутреннюю таблицу лидов для владельца проекта.',
    'next_step' => 'Подготовить презентацию и коммерческое предложение: короткий сценарий показа, состав пилота, ограничения бесплатной версии и понятный следующий шаг для потенциального клиента.',
