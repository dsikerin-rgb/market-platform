...
return [
    ...
    'current_focus' => 'На staging создан демо-рынок с русскими пользователями, арендаторами, местами, финансами и простой картой. Следующий маленький пакет — безопасная выдача демо-доступов: общий пароль только через env, владельцы показа указаны отдельно, prod DB writes не включаются.',
    'next_step' => 'Задеплоить пакет демо-доступов на staging/prod с flags off, затем на staging повторить demo:provision --execute с временным DEMO_PILOT_ACCESS_PASSWORD и выдать доступ владельцу 321_123@bk.ru.',
    ...
    'stages' => [
        ...
        [
            ...
            'items' => [
                ...
                ['title' => 'Механизм демо-доступов: пароль только через env, владелец показа 321_123@bk.ru, без перезаписи реального аккаунта', 'status' => 'in_progress'],
