...
return [
    ...
    'current_focus' => 'Перевести marketplace:slides:seed-defaults на безопасный dry-run по умолчанию, --execute только с явным --market и MarketContext.',
