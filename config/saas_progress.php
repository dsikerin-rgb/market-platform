...
return [
    ...
    'current_focus' => 'Demo-контур создан на prod как отдельный рынок id=2 без изменения боевого рынка id=1: перенесены 244 места, 228 фигур карты, 21 арендатор, 5 пользователей, 14 договоров, финансы, задачи, PDF-подложка и зональная тарифная сетка. Внешние интеграции demo выключены.',
    'next_step' => 'Проверить вход в prod demo в роли директора, затем отдельным безопасным пакетом оформить простой сценарий доступа с landing: кто получает ссылку, какие роли доступны и какие ограничения включены для публичного показа.',
