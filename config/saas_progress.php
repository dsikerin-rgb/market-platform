...
return [
    ...
    'current_focus' => 'Idempotent write adapter расширен до demo market и market_locations: demo:provision может создать или обновить только рынок и его demo-локации; остальные секции пока пропускаются.',
    'next_step' => 'Следующий малый пакет: расширить write adapter на tenants/spaces только для local/staging и только после отдельной проверки; prod data writes останутся под отдельным разрешением.',
    ...
    'stages' => [
        ...
        [
            ...
            'items' => [
                ...
                ['title' => 'demo:provision idempotent write adapter для local/staging: demo market и market_locations', 'status' => 'done'],
