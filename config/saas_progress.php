...
return [
    ...
    'current_focus' => 'Базовая sales-воронка закрыта: landing, заявка, простой demo-entry за flag, таблица лидов, презентационный сценарий и КП зафиксированы.',
    'next_step' => 'Подготовить регламент обработки первых лидов: SLA связи, квалификационные вопросы, шаблон ответа и отдельное решение по включению public demo flag на prod.',
