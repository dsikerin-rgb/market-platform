...
return [
    ...
    'current_focus' => 'Подготовить 1C API к MarketContext без включения tenant scope; payments, settlements и contract debts endpoints завернуты в context из integration token.',
    'next_step' => 'Расширить такой же безопасный wrapper на contracts и accruals, затем перейти к jobs/commands.',
    ...
    'stages' => [
        ...
        [
            ...
            'items' => [
                ...
                ['title' => '1C API выставляет context из integration token: payments + settlements + contract debts endpoints подготовлены', 'status' => 'in_progress'],
