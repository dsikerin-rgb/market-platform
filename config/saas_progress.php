...
return [
    ...
    'current_focus' => 'Перевести market:holidays:generate-images на безопасный dry-run по умолчанию, --execute только с явным --market и MarketContext.',
