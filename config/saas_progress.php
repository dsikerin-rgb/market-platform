...
return [
    ...
    'current_focus' => 'Подготовить 1C API к MarketContext без включения tenant scope; payments, settlements, contract debts и contracts endpoints завернуты в context из integration token.',
    'next_step' => 'Расширить такой же безопасный wrapper на accruals, затем перейти к jobs/commands.',
    ...
    'stages' => [
        ...
        [
            ...
            'items' => [
                ...
                ['title' => '1C API выставляет context из integration token: payments + settlements + contract debts + contracts endpoints подготовлены', 'status' => 'in_progress'],
