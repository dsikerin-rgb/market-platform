...
return [
    ...
    'current_focus' => 'Перевести market:holidays:seed-promotions на безопасный dry-run по умолчанию, чтобы промо-праздники создавались только через --execute с явным рынком или --all-markets.',
