...
return [
    ...
    'current_focus' => 'Перевести marketplace:backfill-previews на безопасный dry-run по умолчанию, чтобы preview-файлы генерировались только через --execute.',
