...
class MarketOverviewStatsWidget extends StatsOverviewWidget
{
    ...
    protected function getStats(): array
    {
        ...
        // Текущее занято/свободно берём из статуса учётных мест.
        // Child-места с parent являются физическими сегментами карты, а не отдельными торговыми местами.
        ...
        $accountingScopeDesc = $marketScopeDesc . ' · без дочерних сегментов групп';
