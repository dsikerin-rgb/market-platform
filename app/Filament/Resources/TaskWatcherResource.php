...
use App\Filament\Resources\TaskWatcherResource\Pages;
...
class TaskWatcherResource extends Resource
{
    ...
    /**
     * Главное: убираем из левого меню.
     * Наблюдатели — это часть задачи (RelationManager), а не пункт навигации.
    ...
    public static function form(Schema $schema): Schema
    {
        ...
        $formFields = [
            ...
            Forms\Components\Select::make('user_id')
                ->label('Сотрудник')
                ->relationship('user', 'name', function (Builder $query) use ($user) {
                    if (! $user) {
                        return $query->whereRaw('1 = 0');
                    }
    ...
    public static function table(Table $table): Table
    {
        ...
        $table = $table
            ...
            ->recordUrl(fn (TaskWatcher $record): ?string => static::canEdit($record)
    ...
    {
        return [
            'index' => Pages\ListTaskWatchers::route('/'),
            'create' => Pages\CreateTaskWatcher::route('/create'),
            'edit' => Pages\EditTaskWatcher::route('/{record}/edit'),
        ];
    }
