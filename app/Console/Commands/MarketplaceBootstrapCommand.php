...
class MarketplaceBootstrapCommand extends Command
{
    ...
    private const DEMO_PRODUCT_PROFILES = [
        'produce' => [
            ...
            'keywords' => ['овощ', 'фрукт', 'ягод', 'зелень', 'сад', 'урож', 'томат', 'яблок', 'груш', 'картоф'],
            'titles' => [
        ...
        'meat_fish' => [
            ...
            'keywords' => ['мяс', 'рыб', 'колбас', 'птиц', 'стейк', 'шашл', 'фарш', 'деликатес'],
            'titles' => [
        ...
        'dairy' => [
            ...
            'keywords' => ['сыр', 'молок', 'творог', 'сметан', 'кефир', 'йогурт', 'масл', 'молоч'],
            'titles' => [
                'Фермерский сыр',
                'Творог натуральный',
                'Сметана домашняя',
        ...
        'grocery' => [
            'category' => 'Бакалея',
            'keywords' => ['бакале', 'чай', 'кофе', 'мед', 'хлеб', 'пекар', 'кондитер', 'сладост', 'круп', 'спец', 'орех', 'сухофрукт'],
            'titles' => [
                'Домашний хлеб',
                'Мед натуральный',
                'Чай травяной',
        ...
        'clothing' => [
            ...
            'keywords' => ['одеж', 'текстил', 'обув', 'трикотаж', 'плать', 'рубаш', 'брюк', 'куртк', 'аксессуар'],
            'titles' => [
                'Трикотаж базовый',
                'Одежда повседневная',
                'Текстиль для дома',
        ...
        'home' => [
            ...
            'keywords' => ['дом', 'хоз', 'посуд', 'декор', 'интерьер', 'быт', 'сувенир', 'подар', 'кухн'],
            'titles' => [
                'Посуда для кухни',
                'Текстиль для дома',
                'Декор интерьера',
        ...
        'services' => [
            'category' => 'Услуги',
            'keywords' => ['услуг', 'ремонт', 'ателье', 'сервис', 'достав', 'мастер', 'консульт', 'упаков'],
            'titles' => [
